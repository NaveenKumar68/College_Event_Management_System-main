...
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <input type="int" class="form-control col-8" id="people"  placeholder="Enter no of people" required>
   
  </div>
  <div class="form-group row">
    <label for="img" class="col-3">upload img:</label>
    <input type="file" class="form-control col-8"  name='image' placeholder="upload img " required>
